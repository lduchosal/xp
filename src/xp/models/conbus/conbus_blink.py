...
class ConbusBlinkResponse:
    ...
    response: ConbusResponse | None = None
    reply_telegram: ReplyTelegram | None = None
    sent_telegram: SystemTelegram | None = None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        result = {
            ...
            "sent_telegram": (
                ...
                else str(self.sent_telegram)
                if self.sent_telegram
                else None
            ),
            "reply_telegram": (
                self.reply_telegram.to_dict()
                if self.reply_telegram and hasattr(self.reply_telegram, "to_dict")
                else str(self.reply_telegram)
                if self.reply_telegram
                else None
            ),
