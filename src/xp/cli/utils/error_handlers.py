...
class CLIErrorHandler:
    ...
    @staticmethod
    def handle_parsing_error(error: Exception, json_output: bool, 
                           raw_input: str, context: Optional[Dict[str, Any]] = None) -> None:
    ...
    @staticmethod
    def handle_connection_error(error: Exception, json_output: bool, 
        ...
        if "Connection timeout" in str(error):
            ...
            if json_output:
                ...
                if config:
                    ...
                    click.echo(f"Error: Connection timeout after {config['timeout']} seconds")
    ...
    @staticmethod
    def handle_service_error(error: Exception, json_output: bool, 
    ...
    @staticmethod
    def handle_validation_error(error: Exception, json_output: bool, 
                              input_data: str) -> None:
    ...
    @staticmethod
    def handle_file_error(error: Exception, json_output: bool, 
                         file_path: str, operation: str = "processing") -> None:
    ...
    @staticmethod
    def handle_not_found_error(error: Exception, json_output: bool, 
                             item_type: str, identifier: str) -> None:
...
class ServerErrorHandler(CLIErrorHandler):
    ...
    @staticmethod
    def handle_server_startup_error(error: Exception, json_output: bool, 
