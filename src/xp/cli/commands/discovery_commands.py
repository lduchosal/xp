...
def generate_discovery(json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_service_error(e, json_output, "discovery telegram generation")
...
def analyze_discovery_session(log_file_path: str, json_output: bool, time_range: str):
    ...
    try:
        ...
        CLIErrorHandler.handle_file_error(e, json_output, log_file_path, "discovery analysis")