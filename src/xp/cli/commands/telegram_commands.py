...
@telegram_parser_command()
def parse_event_telegram(telegram_string: str, json_output: bool, validate_checksum: bool):
    """
    ...
    try:
        ...
        if json_output:
            ...
            click.echo(formatter.format_validation_result(parsed, checksum_valid, summary))
...
def parse_multiple_telegrams(data_stream: str, json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_parsing_error(e, json_output, data_stream, {"operation": "parse_multiple"})
