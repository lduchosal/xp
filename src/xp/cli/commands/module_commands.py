...
def module_info(identifier: str, json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_not_found_error(e, json_output, "module type", identifier)
...
def module_search(query: str, json_output: bool, field: tuple):
    ...
    try:
        ...
        CLIErrorHandler.handle_service_error(e, json_output, "module search", {"query": query})
