...
def generate_set_link_number(serial_number: str, link_number: int, json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_service_error(e, json_output, "link number telegram generation", {
            "serial_number": serial_number,
            "link_number": link_number
        })
...
def generate_read_link_number(serial_number: str, json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_service_error(e, json_output, "read telegram generation", 
                                           {"serial_number": serial_number})
