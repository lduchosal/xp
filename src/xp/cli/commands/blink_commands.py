...
def blink_on(serial_number: str, json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_service_error(e, json_output, "blink telegram generation", {
            "serial_number": serial_number
        })
...
def blink_off(serial_number: str, json_output: bool):
    ...
    try:
        ...
        CLIErrorHandler.handle_service_error(e, json_output, "unblink telegram generation", {
            "serial_number": serial_number
        })
