...
def parse_log_timestamp(timestamp_str: str, base_date: Optional[datetime] = None) -> datetime:
    """
...
def parse_time_range(time_range_str: str, base_date: Optional[datetime] = None) -> tuple[datetime, datetime]:
    """
