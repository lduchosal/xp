...
class VersionService:
        ...
        try:
            if not isinstance(version_string, str):
                return Response(
                    success=False,
                    data=None,
                    error="Version string must be a string"
                )
            ...
            return Response(
                success=False,
                data=None,
                error=f"Version parsing failed: {str(e)}"
            )
        ...
        try:
            if not isinstance(serial_number, str):
                return Response(
                    success=False,
                    data=None,
                    error="Serial number must be a string"
                )
    ...
    def validate_version_telegram(self, telegram: SystemTelegram) -> Response:
        ...
        try:
            ...
            is_version_request = (
                telegram.system_function == SystemFunction.RETURN_DATA and
                telegram.data_point_id == DataPointType.VERSION
            )
            ...
            return Response(
                ...
                data={
                    ...
                    "function": telegram.system_function.value if telegram.system_function else None,
                    "data_point": telegram.data_point_id.value if telegram.data_point_id else None,
