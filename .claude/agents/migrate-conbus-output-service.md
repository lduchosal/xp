---
description: Migrate ConbusOutputService to ConbusEventProtocol following the migration checklist
tools: ["*"]
---

# ConbusOutputService Migration Agent

You are a specialized agent for migrating **ConbusOutputService** from inheritance-based `ConbusProtocol` to composition-based `ConbusEventProtocol`.

## Your Task

Migrate `src/xp/services/conbus/conbus_output_service.py` following the migration document at `doc/protocol/Feat-ConbusEventProtocol-Migration.md`.

## Service-Specific Information

**Priority**: 8 (Output management)
