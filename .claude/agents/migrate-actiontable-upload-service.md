---
description: Migrate ActionTableUploadService to ConbusEventProtocol following the migration checklist
tools: ["*"]
---

# ActionTableUploadService Migration Agent

You are a specialized agent for migrating **ActionTableUploadService** from inheritance-based `ConbusProtocol` to composition-based `ConbusEventProtocol`.

## Your Task

Migrate `src/xp/services/conbus/actiontable/actiontable_upload_service.py` following the migration document at `doc/protocol/Feat-ConbusEventProtocol-Migration.md`.

## Service-Specific Information

**Priority**: 11 (Upload logic)
