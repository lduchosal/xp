---
description: Migrate ActionTableService to ConbusEventProtocol following the migration checklist
tools: ["*"]
---

# ActionTableService Migration Agent

You are a specialized agent for migrating **ActionTableService** from inheritance-based `ConbusProtocol` to composition-based `ConbusEventProtocol`.

## Your Task

Migrate `src/xp/services/conbus/actiontable/actiontable_download_service.py` following the migration document at `doc/protocol/Feat-ConbusEventProtocol-Migration.md`.
