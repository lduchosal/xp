---
description: Migrate ConbusRawService to ConbusEventProtocol following the migration checklist
tools: ["*"]
---

# ConbusRawService Migration Agent

You are a specialized agent for migrating **ConbusRawService** from inheritance-based `ConbusProtocol` to composition-based `ConbusEventProtocol`.

## Your Task

Migrate `src/xp/services/conbus/conbus_raw_service.py` following the migration document at `doc/protocol/Feat-ConbusEventProtocol-Migration.md`.

## Service-Specific Information

**Priority**: 2 (Simple - minimal state)
