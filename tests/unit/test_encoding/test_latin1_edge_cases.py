...
from src.xp.models.conbus_client_send import TelegramType, ConbusSendRequest
...
"""
    ...
    def test_section_symbol_0xa7(self, client_service, latin1_server):
        ...
        with client_service:
            response = client_service.send_sensor_request("0020012521", TelegramType.TEMPERATURE)
    ...
    def test_registered_symbol_0xae(self, client_service, latin1_server):
        ...
        with client_service:
            response = client_service.send_sensor_request("0020044966", TelegramType.CURRENT)
    ...
    def test_plus_minus_symbol_0xb1(self, client_service, latin1_server):
        ...
        with client_service:
            response = client_service.send_sensor_request("0020042796", TelegramType.HUMIDITY)
    ...
    def test_all_latin1_extended_chars(self, client_service, latin1_server):
        ...
        extended_chars = [
            0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87,  # 128-135
            0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7,  # 160-167
            0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf,  # 168-175
            0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0xb7,  # 176-183
            0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7,  # 192-199
            0xe0, 0xe1, 0xe2, 0xe3, 0xe4, 0xe5, 0xe6, 0xe7,  # 224-231
    ...
    def test_utf8_vs_latin1_comparison(self, client_service):
        ...
        assert "'utf-8' codec can't decode byte 0xa7 in position 23" in str(exc_info.value)
