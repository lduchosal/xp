import pytest
from src.xp.services.xp24_server_service import XP24ServerService, XP24ServerError
...
class TestXP24ServerService:
    ...
    def test_generate_discovery_response(self):
        ...
        response = self.xp24_service.generate_discovery_response()
        
        assert response == '<R0020044991F01DFB>'
