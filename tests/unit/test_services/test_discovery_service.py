...
from src.xp.services.discovery_service import DiscoveryService, DiscoveryError, DeviceInfo
...
class TestDeviceInfo:
    ...
    def test_init_with_all_params(self):
        ...
        device = DeviceInfo("0020030837", checksum_valid=False, raw_telegram="<R0020030837F01DFM>")
        assert device.serial_number == "0020030837"
    ...
    def test_to_dict(self):
        ...
        device = DeviceInfo("0020030837", checksum_valid=True, raw_telegram="<R0020030837F01DFM>")
...
class TestDiscoveryService:
    ...
    def test_parse_discovery_response_invalid_function(self):
        ...
        reply_telegram = Mock(spec=ReplyTelegram)
        reply_telegram.system_function = SystemFunction.RETURN_DATA
        reply_telegram.serial_number = "0020030837"
