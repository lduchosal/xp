...
from src.xp.services.conbus_reverse_proxy_service import ConbusReverseProxyService, ConbusReverseProxyError
...
""")
    ...
    def test_load_config_invalid_yaml(self):
        ...
        temp_invalid = tempfile.NamedTemporaryFile(mode='w', suffix='.yml', delete=False)
    ...
    def test_get_status_with_connections(self):
        ...
        assert data["connections"]["conn_1"]["client_address"] == ("192.168.1.50", 12345)
