import pytest
from src.xp.services.xp33_server_service import XP33ServerService, XP33ServerError
...
class TestXP33ServerService:
    ...
    def setup_method(self):
        """Setup test fixtures"""
        self.xp33lr_service = XP33ServerService('0020042796', 'XP33LR')
    ...
    def test_init_xp33lr_variant(self):
        ...
        service = XP33ServerService('0020042796', 'XP33LR')
    ...
    def test_generate_module_type_response(self):
        ...
        assert '30' in response  # 11 + 37 = 48 = 0x30
    ...
    def test_get_device_info(self):
        ...
        assert info['serial_number'] == '0020042796'
    ...
    def test_get_technical_specs_xp33lr(self):
        ...
        expected_keys = ['power_per_channel', 'total_power', 'load_types', 'dimming_type', 'protection']
    ...
    def test_channel_states_with_different_levels(self):
        ...
        assert response == '<R0020042796F02D12324B19000BC>'
    ...
    def test_integration_with_telegram_service(self):
        ...
        assert reply.serial_number == '0020042796'