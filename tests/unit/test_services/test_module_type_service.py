import pytest
from src.xp.services.module_type_service import ModuleTypeService, ModuleTypeNotFoundError
...
class TestModuleTypeService:
    ...
    def test_get_module_type_invalid_code_raises_error(self):
        ...
        with pytest.raises(ModuleTypeNotFoundError, match="Module type with code 999 not found"):
    ...
    def test_get_module_type_invalid_name_raises_error(self):
        ...
        with pytest.raises(ModuleTypeNotFoundError, match="Module type with name 'INVALID' not found"):
    ...
    def test_search_modules_by_description(self):
        ...
        results = self.service.search_modules("push button", search_fields=["description"])
