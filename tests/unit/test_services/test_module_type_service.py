...
class TestModuleTypeService:
    ...
    def test_get_module_type_by_code(self) -> None:
        """Test getting module type by code."""
        module = self.service.get_module_type(XP2606_CODE)

        assert isinstance(module, ModuleType)
        assert module.code == XP2606_CODE
        assert module.name == "XP2606"

    def test_get_module_type_by_name(self) -> None:
    ...
    def test_get_module_type_by_name_case_insensitive(self) -> None:
        """Test getting module type by name is case-insensitive."""
        module = self.service.get_module_type("xp2606")
        assert module.name == "XP2606"

    def test_get_module_type_invalid_code_raises_error(self) -> None:
    ...
    def test_get_module_type_invalid_name_raises_error(self) -> None:
    ...
    def test_list_all_modules(self) -> None:
        ...
        assert len(modules) == TOTAL_MODULE_COUNT
        assert all(isinstance(module, ModuleType) for module in modules)

    def test_list_modules_by_category(self) -> None:
        ...
        assert total_modules == TOTAL_MODULE_COUNT

    def test_search_modules_by_name(self) -> None:
    ...
    def test_search_modules_both_fields(self) -> None:
    ...
    def test_search_modules_case_insensitive(self) -> None:
    ...
    def test_get_ir_capable_modules(self) -> None:
    ...
    def test_validate_module_code_valid(self) -> None:
    ...
    def test_validate_module_code_invalid(self) -> None:
    ...
    def test_get_module_info_summary_valid_code(self) -> None:
    ...
    def test_get_module_info_summary_valid_name(self) -> None:
    ...
    def test_get_module_info_summary_invalid(self) -> None:
    ...
    def test_get_all_modules_summary_simple(self) -> None:
    ...
    def test_get_all_modules_summary_by_category(self) -> None:
    ...
    def test_format_module_summary_with_features(self) -> None:
        ...
        # No public API formats a single module summary
        summary = self.service._format_module_summary(module)  # noqa: SLF001
    ...
    def test_format_module_summary_reserved(self) -> None:
