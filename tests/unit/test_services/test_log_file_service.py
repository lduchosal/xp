...
class TestLogFileService:
    ...
    def test_parse_log_file_success(self, mock_file_open, mock_is_file, mock_exists):
        ...
        mock_file_open.return_value = mock_open(read_data="22:44:20,352 [TX] <test>").return_value
    ...
    def test_filter_entries_by_time_range(self):
        ...
        result = service.filter_entries(entries, start_time=start_time, end_time=end_time)
    ...
    def test_filter_entries_multiple_criteria(self):
        ...
        entries = [
            ...
            Mock(telegram_type="event", direction="RX", timestamp=base_time.replace(second=25)),
            Mock(telegram_type="system", direction="TX", timestamp=base_time.replace(second=30)),
            Mock(telegram_type="event", direction="TX", timestamp=base_time.replace(second=35)),
        ]
