...
class TestInputChannel:
    ...
    def test_and_functions_initialization(self) -> None:
    ...
    def test_and_functions_custom_list(self) -> None:
...
class TestXp20MsActionTable:
    ...
    def test_input_channel_independence(self) -> None:
    ...
    def test_and_functions_list_independence(self) -> None:
...
class TestXp20ShortFormat:
    ...
    def test_to_short_format_default(self) -> None:
    ...
    def test_to_short_format_single_channel(self) -> None:
    ...
    def test_to_short_format_all_flags_enabled(self) -> None:
    ...
    def test_to_short_format_mixed_configuration(self) -> None:
    ...
    def test_from_short_format_single_channel(self) -> None:
    ...
    def test_from_short_format_all_flags_enabled(self) -> None:
    ...
    def test_from_short_format_mixed_configuration(self) -> None:
    ...
    def test_round_trip_conversion_default(self) -> None:
    ...
    def test_round_trip_conversion_complex(self) -> None:
    ...
    def test_from_short_format_invalid_line_count(self) -> None:
        """Test parsing fails with wrong number of lines."""
        short = ["CH1 I:0 S:0 G:0 AND:00000000 SA:0 TA:0"] * 5

        with pytest.raises(ValueError, match="Expected 8 channel lines"):
    ...
    def test_from_short_format_invalid_channel_number(self) -> None:
    ...
    def test_from_short_format_invalid_binary_value(self) -> None:
    ...
    def test_from_short_format_missing_channel(self) -> None:
    ...
    def test_from_short_format_with_whitespace(self) -> None:
