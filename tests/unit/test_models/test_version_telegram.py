...
class TestVersionSystemTelegram(unittest.TestCase):
    ...
    def test_version_system_telegram_creation(self):
        ...
        self.assertEqual(self.version_system_telegram.system_function, SystemFunction.RETURN_DATA)
        self.assertEqual(self.version_system_telegram.data_point_id, DataPointType.VERSION)
    ...
    def test_version_system_telegram_descriptions(self):
        ...
        self.assertEqual(self.version_system_telegram.function_description, "Return Data")
...
class TestVersionReplyTelegram(unittest.TestCase):
    ...
    def test_version_reply_telegram_creation(self):
        ...
        self.assertEqual(self.version_reply_telegram.system_function, SystemFunction.RETURN_DATA)
        self.assertEqual(self.version_reply_telegram.data_point_id, DataPointType.VERSION)
    ...
    def test_version_reply_telegram_descriptions(self):
        ...
        self.assertEqual(self.version_reply_telegram.function_description, "Data Response")
    ...
    def test_version_formats(self):
        ...
        test_cases = [
            ("XP230_V1.00.04", {"product": "XP230", "version": "1.00.04", "parsed": True}),
            ("XP20_V0.01.05", {"product": "XP20", "version": "0.01.05", "parsed": True}),
            ("XP33LR_V0.04.02", {"product": "XP33LR", "version": "0.04.02", "parsed": True}),
            ("XP24_V0.34.03", {"product": "XP24", "version": "0.34.03", "parsed": True}),
