...
from src.xp.models.module_type import (
    ModuleType, ModuleTypeCode, MODULE_TYPE_REGISTRY, 
    get_all_module_types, get_module_types_by_category, is_valid_module_code
)
...
class TestModuleType:
    ...
    def test_to_dict(self):
        ...
        expected_keys = {
            ...
            "is_reserved", "is_push_button_panel", "is_ir_capable"
        }
