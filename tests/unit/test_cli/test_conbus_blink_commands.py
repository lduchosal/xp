...
class TestConbusBlinkCommands:
    ...
    def test_conbus_blink_help(self) -> None:
    ...
    def test_conbus_unblink_help(self) -> None:
    ...
    def test_conbus_blink_invalid_serial_json(self) -> None:
        ...
        assert (
            "Error: Invalid value for 'SERIAL_NUMBER': "
            "'invalid' contains non-numeric characters" in result.output
        )
