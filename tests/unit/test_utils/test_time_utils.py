...
class TestTimeUtils:
    ...
    def test_parse_log_timestamp_valid(self):
        ...
        expected = datetime.combine(today, datetime.strptime("22:44:20.352", "%H:%M:%S.%f").time())
    ...
    def test_parse_time_range_valid(self):
        ...
        today = datetime.now().date()
        expected_start = datetime.combine(today, datetime.strptime("22:44:20.352", "%H:%M:%S.%f").time())
        expected_end = datetime.combine(today, datetime.strptime("22:44:25.500", "%H:%M:%S.%f").time())
