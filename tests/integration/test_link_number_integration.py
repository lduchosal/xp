...
class TestLinkNumberIntegration:
    ...
    def test_complete_set_link_number_workflow(self):
        ...
        generated_telegram = link_service.generate_set_link_number_telegram(serial, link_num)
    ...
    def test_telegram_object_creation_and_parsing_consistency(self):
        ...
        created_telegram = link_service.create_set_link_number_telegram_object("0020044974", 25)
        
        # Parse the raw telegram from the created object
        parsed_telegram = telegram_service.parse_system_telegram(created_telegram.raw_telegram)
    ...
    def test_checksum_validation_integration(self):
        ...
        for link_num in test_link_numbers:
            # Generate telegram
            telegram_str = link_service.generate_set_link_number_telegram("1234567890", link_num)
    ...
    def test_error_handling_integration(self):
        ...
        valid_telegram = link_service.generate_set_link_number_telegram("0020044974", 25)
    ...
    def test_boundary_values_integration(self):
        ...
        for serial, link_num in boundary_cases:
            # Generate and parse
            telegram_str = link_service.generate_set_link_number_telegram(serial, link_num)
            parsed = telegram_service.parse_system_telegram(telegram_str)
