...
from xp.services.conbus_datapoint_service import ConbusDatapointService, ConbusDatapointError
...
class TestConbusDatapointService:
    ...
    def test_query_all_datapoints_success(self, mock_telegram_service, mock_conbus_service):
