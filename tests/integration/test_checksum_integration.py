...
class TestChecksumIntegration:
    ...
    def test_checksum_validate_invalid_checksum(self):
        ...
        result = self.runner.invoke(cli, ["checksum", "validate", "test", "XX"])
    ...
    def test_checksum_validate_crc32_algorithm(self):
        ...
        # Then validate it
        result = self.runner.invoke(
            cli, ["checksum", "validate", "test", checksum, "--algorithm", "crc32"]
        )
    ...
    def test_checksum_help_command(self):
        ...
        result = self.runner.invoke(cli, ["checksum", "--help"])
    ...
    def test_checksum_calculate_help(self):
        ...
        result = self.runner.invoke(cli, ["checksum", "calculate", "--help"])
    ...
    def test_checksum_validate_help(self):
        ...
        result = self.runner.invoke(cli, ["checksum", "validate", "--help"])
    ...
    def test_checksum_validate_empty_string(self):
        ...
        result = self.runner.invoke(cli, ["checksum", "validate", "", "AA"])
    ...
    def test_algorithm_parameter_validation(self):
        ...
        result = self.runner.invoke(
            cli, ["checksum", "calculate", "test", "--algorithm", "invalid"]
        )
    ...
    def test_missing_arguments(self):
        ...
        result = self.runner.invoke(cli, ["checksum", "validate", "test"])
        assert result.exit_code != 0
