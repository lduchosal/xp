...
class TestDiscoveryIntegration:
    ...
    def test_discovery_response_format_validation_integration(self):
        ...
        for response in valid_responses:
            ...
            assert discovery_service.validate_discovery_response_format(response) is True
        ...
        for response in invalid_responses:
            assert discovery_service.validate_discovery_response_format(response) is False
