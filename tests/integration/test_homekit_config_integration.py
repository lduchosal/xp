...
class TestHomekitConfigIntegration:
        ...
        homekit_data = {
            ...
            'bridge': {
                ...
                'rooms': [
                    {
                        'name': 'Living Room',
                        'accessories': ['main_light', 'side_lamp']
                    },
                    {
                        'name': 'Kitchen',
                        'accessories': ['kitchen_light']
                    }
                ]
            },
            'accessories': [
        ...
        homekit_data = {
            ...
            'bridge': {
                ...
                'rooms': [
                    {
                        'name': 'Living Room',
                        'accessories': ['main_light', 'nonexistent_light']  # Non-existent accessory
                    },
                    {
    ...
    def test_malformed_yaml_integration(self):
        ...
        malformed_conson = tempfile.NamedTemporaryFile(mode='w', suffix='.yml', delete=False)
