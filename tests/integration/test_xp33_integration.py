...
class TestXP33Integration:
    ...
    def test_xp33_broadcast_requests(self):
        ...
        xp33_responses = [
            r for r in valid_responses if ("0020042796" in r or "0020042797" in r)
        ]
    ...
    def test_complete_xp33_workflow(self):
        ...
        discovery_valid = [
            r.strip() for r in discovery_responses if r.strip() and "0020042796" in r
        ]
        ...
        initial_channel_response = (
            channel_responses[0].strip() if channel_responses else None
        )
        ...
        modified_channel_response = (
            channel_responses_2[0].strip() if channel_responses_2 else None
        )
        ...
        scene_channel_response = (
            channel_responses_3[0].strip() if channel_responses_3 else None
        )
