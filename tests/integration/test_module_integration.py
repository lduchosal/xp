...
class TestModuleIntegration:
    ...
    def test_module_list_command_group_by_category_json(self):
        ...
        result = self.runner.invoke(cli, ['module', 'list', '--group-by-category', '--json-output'])
    ...
    def test_module_search_command_json_output(self):
        ...
        result = self.runner.invoke(cli, ['module', 'search', 'XP2606', '--json-output'])
    ...
    def test_enhanced_telegram_parsing_with_module_info(self):
        ...
        assert output['module_info']['description'] == '5 way push button panel with sesam, L-Team design'
    ...
    def test_enhanced_telegram_parsing_unknown_module(self):
        ...
        result = self.runner.invoke(cli, ['telegram', 'parse', '<E99L00I02MAK>', '--json-output'])
