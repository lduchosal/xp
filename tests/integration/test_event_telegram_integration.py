...
class TestEventTelegramIntegration:
    ...
    def test_parse_event_telegram_command_invalid_format(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "parse", "INVALID"]) # type: ignore
    ...
    def test_parse_event_telegram_command_invalid_format_json(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "INVALID"] # type: ignore
        )
    ...
    def test_validate_telegram_command_valid_json(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "validate", "<E14L00I02MAK>"] # type: ignore
        )
    ...
    def test_validate_telegram_command_invalid(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "validate", "INVALID"]) # type: ignore
    ...
    def test_validate_telegram_command_invalid_json(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "validate", "INVALID"] # type: ignore
        )
    ...
    def test_main_cli_help(self):
        """Test main CLI help"""
        result = self.runner.invoke(cli, ["--help"]) # type: ignore
    ...
    def test_parse_event_telegram_button_release(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "parse", "<E14L01I03BB1>"]) # type: ignore
    ...
    def test_parse_event_telegram_ir_remote(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "parse", "<E14L00I25MXX>"]) # type: ignore
    ...
    def test_parse_event_telegram_proximity_sensor(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "parse", "<E14L00I90MXX>"]) # type: ignore
    ...
    def test_end_to_end_workflow(self):
        ...
        validate_result = self.runner.invoke(
            cli, ["telegram", "validate", telegram] # type: ignore
        )
