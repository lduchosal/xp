...
class TestEventTelegramIntegration:
    ...
    def test_parse_event_telegram_command_success(self):
        ...
        assert "XP2606 (Type 14) Link 00 Input 02 (push_button) pressed" in result.output
    ...
    def test_parse_event_telegram_command_json_output(self):
        ...
        result = self.runner.invoke(cli, ['telegram', 'parse', '<E14L00I02MAK>', '--json-output'])
    ...
    def test_parse_event_telegram_command_with_checksum_validation(self):
        ...
        result = self.runner.invoke(cli, [
            'telegram', 'parse-event', '<E14L00I02MAK>', '--validate-checksum'
        ])
    ...
    def test_parse_event_telegram_command_invalid_format_json(self):
        ...
        result = self.runner.invoke(cli, ['telegram', 'parse', 'INVALID', '--json-output'])
    ...
    def test_parse_multiple_event_telegrams_command_success(self):
        ...
        assert "XP2606 (Type 14) Link 00 Input 02 (push_button) pressed" in result.output
        assert "XP2606 (Type 14) Link 01 Input 03 (push_button) released" in result.output
    
    def test_parse_multiple_event_telegrams_command_json_output(self):
        """Test parsing multiple telegrams with JSON output"""
        data = "Some data <E14L00I02MAK> more <E14L01I03BB1> end"
        result = self.runner.invoke(cli, ['telegram', 'parse-multiple', data, '--json-output'])
    ...
    def test_parse_multiple_event_telegrams_command_no_telegrams(self):
        ...
        result = self.runner.invoke(cli, ['telegram', 'parse-multiple', 'No telegrams here'])
    ...
    def test_validate_telegram_command_valid_json(self):
        ...
        result = self.runner.invoke(cli, ['telegram', 'validate', '<E14L00I02MAK>', '--json-output'])
    ...
    def test_validate_telegram_command_invalid_json(self):
        ...
        result = self.runner.invoke(cli, ['telegram', 'validate', 'INVALID', '--json-output'])
    ...
    def test_parse_event_telegram_proximity_sensor(self):
        ...
        assert result.exit_code == 0
        assert "XP2606 (Type 14) Link 00 Input 90 (proximity_sensor) pressed" in result.output
    ...
    def test_end_to_end_workflow(self):
        ...
        # Parse telegram
        parse_result = self.runner.invoke(cli, ['telegram', 'parse', telegram, '--json-output'])
        assert parse_result.exit_code == 0
        parse_data = json.loads(parse_result.output)
        
        # Validate telegram
        validate_result = self.runner.invoke(cli, ['telegram', 'validate', telegram, '--json-output'])
    ...
    def test_parse_event_telegram_json_with_checksum_validation(self):
        ...
        result = self.runner.invoke(cli, [
            'telegram', 'parse-event', '<E14L00I02MAK>',
            '--json-output', '--validate-checksum'
        ])
    ...
    def test_parse_multiple_event_telegrams_exception_handling(self):
        ...
        with unittest.mock.patch('src.xp.services.telegram_service.TelegramService.parse_multiple_telegrams') as mock_method:
    ...
    def test_parse_multiple_event_telegrams_exception_handling_json(self):
        ...
        with unittest.mock.patch('src.xp.services.telegram_service.TelegramService.parse_multiple_telegrams') as mock_method:
            ...
            result = self.runner.invoke(cli, ['telegram', 'parse-multiple', 'test data', '--json-output'])
            assert result.exit_code == 1
