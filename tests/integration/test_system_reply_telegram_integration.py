...
class TestSystemTelegramCLI:
    ...
    def test_parse_system_telegram_command(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S0020012521F02D18FN>"] # type: ignore
        )
    ...
    def test_parse_system_telegram_different_functions(self):
        ...
        # Update firmware
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S0020012521F01D18FN>"] # type: ignore
        )
        ...
        # Read config
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S0020012521F03D18FN>"] # type: ignore
        )
    ...
    def test_parse_system_telegram_different_data_points(self):
        ...
        # Humidity
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S0020012521F02D19FN>"] # type: ignore
        )
        ...
        # Status
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S0020012521F02D00FN>"] # type: ignore
        )
    ...
    def test_parse_system_telegram_invalid_format(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S002001252F02D18FN>"] # type: ignore
        )
    ...
    def test_parse_system_telegram_unknown_function(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<S0020012521F99D18FN>"] # type: ignore
        )
...
class TestReplyTelegramCLI:
    ...
    def test_parse_reply_telegram_command(self):
        """Test telegram parse command."""
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<R0020012521F02D18+26,0§CIL>"] # type: ignore
        )
    ...
    def test_parse_reply_telegram_status_data(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<R0020012521F02D00OKIL>"] # type: ignore
        )
    ...
    def test_parse_reply_telegram_invalid_format(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<R002001252F02D18+26,0§CIL>"] # type: ignore
        )
...
class TestAutoDetectTelegramCLI:
    ...
    def test_parse_telegram_system(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "parse", "<S0020012521F02D18FN>"]) # type: ignore
    ...
    def test_parse_telegram_unknown_type(self):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", "<X0020012521F02D18+26,0§CIL>"] # type: ignore
        )
    ...
    def test_parse_telegram_help(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "parse", "--help"]) # type: ignore
    ...
    def test_parse_telegram_type_detection(self, telegram, expected_type):
        ...
        result = self.runner.invoke(
            cli, ["telegram", "parse", telegram] # type: ignore
        )
...
class TestTelegramCLIIntegration:
    ...
    def test_telegram_help_shows_all_commands(self):
        ...
        result = self.runner.invoke(cli, ["telegram", "--help"]) # type: ignore
    ...
    def test_all_telegram_commands_exist(self):
        ...
        for cmd in commands:
            result = self.runner.invoke(cli, ["telegram", cmd, "--help"]) # type: ignore
    ...
    def test_consistent_json_output_format(self):
        ...
        for cmd, telegram in telegrams:
            result = self.runner.invoke(
                cli, ["telegram", cmd, telegram] # type: ignore
            )
    ...
    def test_missing_arguments_handled_consistently(self):
        ...
        for cmd in commands:
            result = self.runner.invoke(cli, ["telegram", cmd]) # type: ignore
