...
from src.xp.models.system_telegram import SystemFunction, DataPointType
...
class TestVersionIntegration(unittest.TestCase):
    ...
    def test_parse_version_system_telegram_from_spec(self):
        ...
        self.assertEqual(parsed.system_function, SystemFunction.RETURN_DATA)
    ...
    def test_parse_version_reply_telegrams_from_spec(self):
        ...
        for raw_telegram, expected_product, expected_version in test_cases:
            with self.subTest(raw_telegram=raw_telegram):
                ...
                self.assertEqual(version_data["full_version"], f"{expected_product}_V{expected_version}")
                ...
                self.assertEqual(version_result.data["version_info"]["product"], expected_product)
                self.assertEqual(version_result.data["version_info"]["version"], expected_version)
    ...
    def test_generate_and_parse_version_request(self):
        ...
        generation_result = self.version_service.generate_version_request_telegram(serial_number)
    ...
    def test_version_parsing_edge_cases(self):
        ...
        edge_cases = [
            ...
            # Long product name
            ("<R0020000000F02D02VERYLONGPRODUCTNAME_V9.99.99XX>", "VERYLONGPRODUCTNAME", "9.99.99"),
        ]
    ...
    def test_telegram_service_format_version_reply(self):
        ...
        self.assertIn("Reply Telegram: Data Response for Version = XP230 v1.00.04", summary)
